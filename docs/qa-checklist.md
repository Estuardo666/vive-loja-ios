...
La matriz automatizada actual cubre default, `XS`, `Accessibility3` y `Accessibility5` y comprueba los tabs, controles principales y labels accesibles: [Actions run 33540266729](https://github.com/Estuardo666/vive-loja-ios/actions/runs/33540266729) (15 XCTest + 13 UI tests, 0 fallos). El workflow exporta además los attachments de screenshot a un artifact `ios-screenshots` cuando `xcresulttool` está disponible, para revisión comparativa por checkpoint. La validación final de VoiceOver, tamaños extremos y navegación táctil debe repetirse en un iPhone físico antes de firmar.
