...
La matriz automatizada actual cubre default, `XS`, `Accessibility3` y `Accessibility5` y comprueba los tabs, controles principales y labels accesibles: [Actions run 33546960854](https://github.com/Estuardo666/vive-loja-ios/actions/runs/33546960854) (15 XCTest + 13 UI tests, 0 fallos). El workflow exporta los attachments de screenshot a los artifacts `ios-test-results`/`ios-screenshots`; el harness oscuro `-uiTesting-dark` hace reproducibles las capturas sin cambiar el comportamiento de producción. La validación final de VoiceOver, tamaños extremos, comparación pixelada y navegación táctil debe repetirse en un iPhone físico antes de firmar.
